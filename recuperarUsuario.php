        ...
        <div class="formulario ">
            <form method="POST">
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" name="claveN" id="claveN" required>
                </div>
                <div class="mb-3">
                    <label class="form-label">Repetir contraseña</label>
                    <input type="password" class="form-control" name="claveR" id="claveR" required>
                </div>
                <button type="submit" class="btn btn-primary" name="aceptar" >Confirmar</button>
            </form> 
        </div>
    </div>
